...
1. Install **Java 27+** and the **Clojure CLI tools** (e.g., `brew install clojure/tools/deps` on macOS or follow https://clojure.org/guides/install_clojure for Linux/Windows).
