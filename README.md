...
- **Stream heap dump stats** via a native WebSocket and a dedicated UI page powered by JOL.
...
| `GET`  | `/ws/heapdump`          | Native WebSocket for streaming `.hprof` uploads and receiving JOL heapdump stats output. |
